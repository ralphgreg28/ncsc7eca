...
function Home() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Welcome to NCSC</h1>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          >
            ...
            <h3 className="font-medium text-indigo-900">Citizen List</h3>
          ...
          >
            ...
            <h3 className="font-medium text-green-900">Add New Citizen</h3>
