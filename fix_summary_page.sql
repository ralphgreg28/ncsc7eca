-- Fix for Summary page "Failed to load summary data" error
-- Run this in your Supabase SQL Editor

-- The issue: The dashboard functions have inconsistent parameter signatures.
-- The Summary.tsx component passes p_age_start and p_age_end to all functions,
-- but some functions don't accept these parameters, causing RPC calls to fail.

-- Solution: Drop and recreate the three functions with consistent parameter signatures

-- 1. Drop existing versions of the functions
...
-- 2. Create get_dashboard_payment_stats with age parameters
...
-- 3. Create get_dashboard_province_stats with age parameters
...
-- 4. Create get_dashboard_lgu_stats with age parameters
